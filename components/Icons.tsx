...
import {
  ...
  FilePlus, FolderOpen, Save, Album, Key, Sliders, Database, ChevronRight, ChevronLeft, ChevronDown, ChevronUp,
  ...
  Paperclip, AtSign, Music, Hash, Eraser, Type
} from 'lucide-react';
...
export const Icons = {
  ...
  ArrowUpDown, ArrowUp, ArrowDown, Paperclip, AtSign, Music, Hash, Eraser, Type,
  History: Clock,
};
