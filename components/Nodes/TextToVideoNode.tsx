...
export const TextToVideoNode: React.FC<TextToVideoNodeProps> = ({
  ...
  const inputBg = isDark
    ...
    : "bg-gray-50 hover:bg-white border-gray-200 focus:border-purple-500 text-gray-900 placeholder-gray-400";
  ...
  return (
    <>
      ...
      {isSelectedAndStable && showControls && (
        <div
          className="absolute top-full left-1/2 -translate-x-1/2 min-w-[580px] pt-4 z-[70] pointer-events-auto"
                ...
                className={`shrink-0 w-8 h-8 rounded-lg flex items-center justify-center transition-all border ${
                  data.isOptimizing
                    ? isDark
                      ...
                      : "text-purple-600 bg-purple-100 border-purple-200 animate-pulse"
                    : data.promptOptimize
                      ? isDark
