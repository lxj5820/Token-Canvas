...
export const ImageNodeToolbar: React.FC<ImageNodeToolbarProps> = ({
  ...
  return (
    ...
    >
      {/* 全景 */}
      <button
        className={`inline-flex select-none items-center justify-center rounded-lg transition-colors h-7 gap-1 px-2.5 cursor-pointer ${isPanoramaEditing ? textBtnActive : textBtnBase}`}
        title="全景"
        data-testid="image-toolbar-panorama"
        onClick={onPanoramaEdit}
      >
        <svg
        ...
        <span className="whitespace-nowrap text-xs leading-none">全景</span>
      </button>
      ...
      >
        <svg
          ...
          aria-hidden="true"
          role="img"
          className="iconify iconify--libtv pointer-events-none h-4 w-4"
          width="1em"
          height="1em"
      ...
      >
        <svg
          ...
          aria-hidden="true"
          role="img"
          className="iconify iconify--libtv pointer-events-none h-4 w-4 shrink-0"
          width="1em"
          height="1em"
          viewBox="0 0 20.001 20.001"
        >
          <path
            d="M20.001 17.001L19.9971 17.1553C19.919 18.6888 18.6888 19.919 17.1553 19.9971L17.001 20.001H11.6807V18.501H17.001C17.8289 18.5006 18.5006 17.8289 18.501 17.001V11.665H20.001V17.001ZM7.00098 11.251C7.96725 11.2512 8.75097 12.0346 8.75098 13.001V18.001C8.75071 18.9671 7.96709 19.7507 7.00098 19.751H2.00098C1.03465 19.751 0.25124 18.9672 0.250977 18.001V13.001C0.250979 12.0345 1.03449 11.251 2.00098 11.251H7.00098ZM2.00098 12.751C1.86291 12.751 1.75098 12.8629 1.75098 13.001V18.001C1.75124 18.1388 1.86308 18.251 2.00098 18.251H7.00098C7.13866 18.2507 7.25071 18.1387 7.25098 18.001V13.001C7.25097 12.8631 7.13882 12.7512 7.00098 12.751H2.00098ZM17.1553 0.00488281C18.7401 0.0855464 20.001 1.39611 20.001 3.00098V9.13965H18.501V3.00098C18.501 2.87858 18.4847 2.75939 18.457 2.64551L11.5205 9.58301L10.46 8.52246L17.4199 1.56152C17.287 1.52289 17.1463 1.50104 17.001 1.50098H11.6807V0H17.001L17.1553 0.00488281ZM9.15527 1.50098H3.00098C2.17255 1.50098 1.50098 2.17255 1.50098 3.00098V9.13965H0V3.00098C0 1.39587 1.26153 0.0851907 2.84668 0.00488281L3.00098 0H9.15527V1.50098Z"
            fill="currentColor"
          ></path>
        </svg>
