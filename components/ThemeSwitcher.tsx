...
export const ThemeSwitcher: React.FC<ThemeSwitcherProps> = ({
  ...
  return (
    <div
      className={`flex items-center backdrop-blur-md border rounded-full p-1 shadow-lg transition-colors ${isDark ? "bg-black/20 border-white/10" : "bg-white/50 border-gray-200"}`}
    >
      <button
