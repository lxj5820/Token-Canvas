...
export const getDefaultModel = (type: NodeType): string => {
  switch (type) {
    case NodeType.TEXT_TO_IMAGE: return 'Banana 2';
    case NodeType.TEXT_TO_VIDEO: return 'Sora 2';
    case NodeType.TEXT_TO_AUDIO: return 'Suno';
    default: return '';
  }
};
...
/** 根据节点类型获取默认尺寸 */
export const getDefaultNodeSize = (type: NodeType, dataOverride?: Partial<{ width: number; height: number }>) => {
