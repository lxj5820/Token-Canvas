import type { ImageModelRules, ModelConfig, IModelHandler } from "../types";
...
export const BananaProHandler = {
  ...
  generate: async (cfg: ModelConfig, prompt: string, params: any) => {
    ...
    return await generateBananaChatImage(
      cfg,
      prompt,
      params.aspectRatio,
      params.resolution,
...
export const ZimageHandler = {
  ...
  generate: async (cfg: ModelConfig, prompt: string, params: any) => {
    ...
    return await generateStandardImage(
      cfg,
      { id: "z-image-turbo", name: "Zimage Turbo", type: "IMAGE_GEN" } as any,
      prompt,
      params.aspectRatio,
      "1k",
      size,
...
export const FluxProHandler = {
  ...
  generate: async (cfg: ModelConfig, prompt: string, params: any) => {
    ...
    return await generateStandardImage(
      cfg,
      { id: "flux-pro", name: "Flux Pro", type: "IMAGE_GEN" } as any,
      prompt,
      params.aspectRatio,
      params.resolution,
      size,
...
export const KlingImageHandler = {
  ...
  generate: async (cfg: ModelConfig, prompt: string, params: any) => {
    ...
    return await generateStandardImage(
      cfg,
      { id: "kling-image", name: "Kling Image", type: "KLING_OMNI" } as any,
      prompt,
      params.aspectRatio,
      "1k",
      size,
 ...
 * 键为模型名称，值为对应的处理器
 */
export const IMAGE_HANDLERS: Record<string, IModelHandler<ImageModelRules>> = {
