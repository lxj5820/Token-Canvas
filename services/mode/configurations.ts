...
import { generateGenericVideo, generateGenericAudio, generateGenericText, generateGenericChat, generateGenericImage } from "./generic";
import { generateSoraVideo } from "./video/sora";
import { generateVeo3Video, generateVeo2Video, Veo2ComponentsHandler } from "./video/veo";
import { generateKlingVideo, generateKlingOmniVideo, KlingVideoHandler, KlingOmniVideoHandler } from "./video/kling";
...
export const VIDEO_HANDLERS: Record<string, ModelHandler> = {
    ...
    'Veo 3.1 Fast': { rules: getVideoModelRules('Veo 3.1 Fast'), generate: generateVeo3Video },
    'Veo 3.1 Pro': { rules: getVideoModelRules('Veo 3.1 Pro'), generate: generateVeo3Video },
    'Veo 3.1 4K': { rules: getVideoModelRules('Veo 3.1 4K'), generate: generateVeo3Video },
    'Veo 3.1 Pro 4K': { rules: getVideoModelRules('Veo 3.1 Pro 4K'), generate: generateVeo3Video },
    'Veo 3.1 Fast Components': { rules: getVideoModelRules('Veo 3.1 Fast Components'), generate: generateVeo3Video },
    'Veo 3.1 Components': { rules: getVideoModelRules('Veo 3.1 Components'), generate: generateVeo3Video },
    'Grok video 3': GrokVideoHandler,
    'Kling 2.5 Pro': KlingVideoHandler,
    'Kling O1 Pro': KlingOmniVideoHandler,
    'Wan2.6': WanHandler,
    'Wan2.5': WanHandler,
    '即梦 3.5': { rules: getVideoModelRules('即梦 3.5'), generate: generateGenericVideo },
    '海螺2.0': { rules: getVideoModelRules('海螺2.0'), generate: generateMinimaxVideo },
...
export const getGenericHandler = (type: string): ModelHandler => {
    switch (type) {
        case 'IMAGE_GEN':
            return { rules: getImageModelRules('Default'), generate: generateGenericImage };
        case 'VIDEO_GEN':
        case 'VIDEO_GEN_STD':
        case 'VIDEO_GEN_CHAT':
        case 'VIDEO_GEN_MINIMAX':
            return { rules: getVideoModelRules('Default'), generate: generateGenericVideo };
        case 'AUDIO_GEN':
            return { rules: getAudioModelRules('Default'), generate: generateGenericAudio };
        case 'TEXT_GEN':
